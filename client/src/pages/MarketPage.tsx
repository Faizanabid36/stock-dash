...
export default function MarketPage() {
    ...
    useEffect(() => {
        document.title = 'Market | StockDash';
    }, []);
    ...
    return (
        <div className='dark:bg-darkBg pb-10 min-h-screen w-full h-full flex flex-col items-center text-center'>
            ...
            <div className='mt-5 text-md px-5 md:text-xl text-gray-600 dark:text-gray-400'>Discover our curated collection of industry giants.</div>
