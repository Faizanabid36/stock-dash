...
import financialDataSVG from '../assets/images/trading-money.jpg';
import stockTradingImage from '../assets/images/stock-trading.jpg';

const HomePage = () => {
  const { data } = useQuery(GET_STOCKS, {
    variables: { limit: 3, random: true },
  });

  useEffect(() => {
    document.title = 'Home | StockDash';
  }, []);
  ...
  return (
    <div className='dark:bg-darkBg flex flex-col min-h-screen items-center justify-center overflow-hidden'>
          ...
          <div className='container mx-auto flex md:px-16 py-24 lg:flex-row flex-col items-center'>
            <div className='lg:flex-grow lg:w-1/2 pr-0 lg:pr-24 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center text-center'>
              ...
              <p className='title-font sm:text-2xl text-xl mb-4 text-gray-700 dark:text-gray-300 whitespace-nowrap'>
                A simulated stock trading platform
              </p>
              <p className='mb-8 sm:text-sm lg:text-lg leading-relaxed dark:text-gray-300'>
                Developed as a portfolio project. Intended for educational
                purposes only, not for real-world application. <br /> Stock
                price fluctuations are simulated randomly, while real data is
              ...
              <div className='flex justify-center flex-nowrap'>
                <Link
                  to='/market'
                  className='max-h-16 text-white bg-green-400 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded whitespace-nowrap'
                >
                  Browse Market
                </Link>
                <Link
      ...
      <section className='text-gray-600 body-font w-full flex flex-col justify-center'>
        <h1 className='title-font text-center sm:text-2xl text-xl font-medium text-gray-900 dark:text-white'>
      ...
      <section className='text-gray-600 body-font p-10'>
        <div className='container mx-auto flex md:px-16 pb-24 lg:flex-row flex-col items-center'>
          <div className='lg:flex-grow lg:w-1/2 pr-0 lg:pr-24 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center text-center'>
            <h1 className='title-font sm:text-3xl text-3xl mb-4 font-medium text-gray-900 dark:text-white'>
              What is StockDash?
            </h1>

            <p className='mb-8 text-md lg:text-lg leading-relaxed dark:text-gray-300'>
              StockDash is a full-stack portfolio project. The technologies used
              were the MERN stack, along with TypeScript, TailwindCSS, SASS,
              Redux, Socket.io, JWT, and Apollo GraphQL.
            </p>
            <div className='flex justify-center flex-nowrap'>
              <a
                href='https://github.com/Faizanabid36/stock-dash'
                aria-label='GitHub'
                target='_blank'
